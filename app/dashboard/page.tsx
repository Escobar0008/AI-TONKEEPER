    ...
    async function loadPrices() {
      ...
      const results = await Promise.allSettled(
        coins.map(async (coin) => {
          const response = await fetch(
            `/api/crypto?coin=${coin}`
          );

          if (!response.ok) {
            throw new Error(
              `${coin}: HTTP ${response.status}`
            );
          }

          const data =
            (await response.json()) as CryptoPrice;
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xs text-blue-200 mt-1">
                  AI continuously analyzes the crypto market, opens and closes trades automatically based on your selected strategy.
                </p>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-[#0B1220] rounded-2xl p-4 border border-slate-800">
              ...
              <p className="text-sm text-gray-400 mt-2">
                TON adoption continues to grow as new projects join the ecosystem.
              </p>
            ...
            <div className="bg-[#0B1220] rounded-2xl p-4 border border-slate-800">
              ...
              <p className="text-sm text-gray-400 mt-2">
                AI is scanning the crypto market for the best trading opportunities.
              </p>
